...
#
#   Name:           Joel Balmes
#   Assignment:     Final - Connect Four - CVC
#   Date:           3/16/2019
#   Class:          CIS 282
#   Description:    Create a computer vs computer connect 4 game
#
############################################################
...
com_one_piece = "\033[31;1m@\033[0m"
com_two_piece = "\033[34;1m@\033[0m"
com_one_score = 0
com_two_score = 0
...
while game_state == 0
  ...
  puts "Computer 1 is red: #{com_one_piece} Computer 2 is blue: #{com_two_piece}"
  puts "Computer 1 goes first, press enter to begin."
  gets
  ...
  while game_state == 1
    ...
    play_index = com_choice - 1
    coordinates = play_piece(play_index,com_one_piece,game_board)
    print_board(game_board)
    win = check_win(com_one_piece,game_board,coordinates)
    ...
    while game_state == 2
      ...
      play_index = com_choice - 1
      coordinates = play_piece(play_index,com_two_piece,game_board)
      print_board(game_board)
      win = check_win(com_two_piece,game_board,coordinates)
  ...
  # computer 1 'win' results
  while game_state == 3
    com_one_score += 1
    puts "Computer 1 wins!"
    puts "The score is: Computer 1: #{com_one_score}, Computer 2: #{com_two_score}"
    puts "Play again?"
    puts "1.-- Play again."
    puts "2.-- Exit game."
