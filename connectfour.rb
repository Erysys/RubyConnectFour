...
#
#   Name:           Joel Balmes
#   Assignment:     Final - Connect Four - PVC
#   Date:           3/16/2019
#   Class:          CIS 282
#   Description:    Create a player vs computer connect 4 game
#
############################################################
...
player_piece = "\033[31;1m@\033[0m"
com_piece = "\033[34;1m@\033[0m"
player_score = 0
com_score = 0
...
while game_state == 0
  ...
  puts "Player is red: #{player_piece} Computer is blue: #{com_piece}"
  puts "Player goes first, press enter to begin."
  gets
  ...
  while game_state == 1
    ...
    coordinates = play_piece(play_index,player_piece,game_board)
    print_board(game_board)
    win = check_win(player_piece,game_board,coordinates)
    ...
    while game_state == 2
      ...
      coordinates = play_piece(play_index,com_piece,game_board)
      print_board(game_board)
      win = check_win(com_piece,game_board,coordinates)
  ...
  # 'win' results (player wins)
  while game_state == 3
    player_score += 1
    puts "You Win! Congratulations"
    puts "The score is: Player: #{player_score}, Computer: #{com_score}"
    puts "Play again?"
    puts "1.-- Play again."
    puts "2.-- Exit game."
  ...
  # 'lose' results (computer wins)
  while game_state == 4
    com_score += 1
    puts "The computer wins. Better luck next time!"
    puts "The score is: Player: #{player_score}, Computer: #{com_score}"
    puts "Play again?"
    puts "1.-- Play again."
    puts "2.-- Exit game."
